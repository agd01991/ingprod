...
echo ' <div class="first" id="first">
<div class="first-text container"><h1>Отзыв не отредактирован :(</h1><h3>Произошла ошибка</h3><a class="btn btn-outline-light" href="../main.php" role="button">На главную</a>';
else // если все прошло нормально – выводим сообщение
echo ' <div class="first" id="first">
<div class="first-text container"><h1>Отзыв отредактирован!</h1><a class="btn btn-outline-light" href="../main.php" role="button">На главную</a>';
